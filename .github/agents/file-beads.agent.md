...
First, review the plan context provided in the chat. If no specific plan is provided, ask the user to share the plan or point to a planning document (check `history/` directory for recent plans).
